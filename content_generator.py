...
def create_content():
    ...
    class Response(BaseModel):
        ...
        # tag: str = Field(description="tag for background videos search on the 'pexels' video stock")
        # video_prompt: str = Field(description="prompt for generating video for article")
